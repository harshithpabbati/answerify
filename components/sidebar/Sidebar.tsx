...
export async function Sidebar({ orgId, name, slug, inboundEmail }: Props) {
  ...
  return (
    <div className="flex h-dvh w-full md:w-auto">
      <div className="bg-black relative flex h-dvh w-16 flex-col items-center justify-between border-r border-[#FF4500]/20">
      ...
      <div className="bg-black border-r-none h-full w-[calc(100dvw-4rem)] md:w-[40dvw] md:border-r md:border-r-[#FF4500]/20 lg:w-[25dvw]">
        <Suspense
          fallback={
            <div className="max-h-dvh">
              <div className="flex h-[60px] items-center justify-between border-b border-[#FF4500]/20 p-4">
                <h3 className="font-mono font-semibold uppercase tracking-wider text-white">{name}</h3>
              </div>
